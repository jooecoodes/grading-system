$(document).ready(function() {
    ...
    function displayFields(numOfStud){
        console.log(numOfStud);
    ...
    console.log($("input[data-key='0']").eq(0).attr('placeholder'));
    console.log($("input[data-key='0']").eq(1).attr('placeholder'));
